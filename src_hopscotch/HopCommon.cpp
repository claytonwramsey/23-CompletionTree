...
int MotionPlanState::step(const RobotVtable &rvArg, CConfig q_start, CConfig q_end,
    const Environment *env, float block_r, bool has_held, CPose held_rel_pose, float *out_buf,
