...
struct Action {
    ...
    size_t surface_index = 0; // which surface to place on; meaningful for Place only
...
struct MotionPlanState {
    ...
    int step(const RobotVtable &rv, CConfig q_start, CConfig q_end, const Environment *env,
